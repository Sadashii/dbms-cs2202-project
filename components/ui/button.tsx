...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
    (
        ...
        const variantStyles = {
            ...
            secondary:
                "bg-blue-50 text-blue-700 hover:bg-blue-100 focus:ring-blue-500 dark:bg-blue-900/20 dark:text-blue-400 dark:hover:bg-blue-900/40",
            ...
            outline:
                "border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 focus:ring-blue-500 shadow-sm dark:border-slate-700 dark:bg-slate-900 dark:text-gray-300 dark:hover:bg-slate-800 dark:hover:text-white",
        };
