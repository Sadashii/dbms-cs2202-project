...
export const Sidebar = () => {
    ...
    const statusFooter = (
        <div className="flex-shrink-0 p-4 border-t border-gray-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50">
            <div className="flex items-center gap-3">
                ...
                <div>
                    <p className="text-[11px] font-bold text-gray-900 dark:text-gray-200 uppercase tracking-tighter">
                        System Health
                    </p>
    ...
    return (
        <>
            ...
            {/* Mobile Drawer */}
            <div
                className={`fixed inset-y-0 left-0 z-50 w-72 bg-white dark:bg-slate-950 shadow-2xl transform transition-transform duration-300 ease-in-out md:hidden flex flex-col ${isMobileOpen ? "translate-x-0" : "-translate-x-full"}`}
            >
