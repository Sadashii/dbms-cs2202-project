                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div className="animate-fade-in-up">
                            ...
                            <p className="text-lg text-slate-400 mb-10 max-w-lg leading-relaxed">
                                Seamless API integration, bulk transaction
                                processing, and elite corporate treasury
                                management designed for unparalleled scale and
                                security.
                            </p>
                            <div className="flex gap-4">
                                <Link href="/auth/signup">
                                    <Button
                                        size="lg"
                                        className="bg-blue-600 hover:bg-blue-500 text-white border-none shadow-[0_0_40px_rgba(37,99,235,0.3)] transition-all hover:scale-105 rounded-full px-8"
                                    >
                                ...
                                <Button
                                    size="lg"
                                    variant="outline"
                                    className="border-slate-700 text-slate-300 hover:bg-slate-800 hover:text-white rounded-full px-8 bg-transparent"
                                >
                                    Contact Sales
                                </Button>
                            </div>
                ...
                <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                    <div className="mb-16 text-center max-w-3xl mx-auto">
                        ...
                        <p className="text-slate-400">
                            Everything you need to automate your company's
                            finances reliably.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div className="bg-[#131B2F] border border-white/5 rounded-2xl p-8 hover:bg-[#1A243F] transition-colors">
                            ...
                            <p className="text-slate-400 text-sm leading-relaxed">
                                Automate payouts, query balances, and receive
                                instant notifications for ledger updates in your
                                own systems.
                            </p>
                        </div>
                        <div className="bg-[#131B2F] border border-white/5 rounded-2xl p-8 hover:bg-[#1A243F] transition-colors">
                            ...
                            <p className="text-slate-400 text-sm leading-relaxed">
                                Delegate access to your accounting team. Set
                                dual-approval workflows for large outgoing
                                transactions.
                            </p>
                        </div>
                        <div className="bg-[#131B2F] border border-white/5 rounded-2xl p-8 hover:bg-[#1A243F] transition-colors">
                            ...
                            <p className="text-slate-400 text-sm leading-relaxed">
                                Upload CSVs or use the API to process thousands
                                of salary deposits instantly with minimal
                                failure rates.
                            </p>
                        </div>
                    </div>
