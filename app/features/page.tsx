                ...
                <div className="text-center max-w-3xl mx-auto animate-fade-in-up">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <Link href="/auth/signup">
                            <Button
                                size="lg"
                                className="w-full sm:w-auto bg-white text-blue-900 hover:bg-gray-10 font-bold border-none shadow-xl transform transition hover:scale-105 active:scale-95"
                            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white/80 backdrop-blur-xl border border-white/50 p-8 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 group">
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            Open high-yield savings or flexible checking
                            accounts in minutes. Track your expenses
                            automatically and grow your money effortlessly with
                            auto-transfers.
                        </p>
                    </div>
                    ...
                    <div className="bg-white/80 backdrop-blur-xl border border-white/50 p-8 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 group">
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            Need cash fast? Get personalized loan offers with
                            transparent EMI calculations. Apply directly from
                            your dashboard and get approved in hours, not days.
                        </p>
                    </div>
                    ...
                    <div className="bg-white/80 backdrop-blur-xl border border-white/50 p-8 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 group">
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            Generate one-time use virtual credit or debit cards
                            for secure online shopping. Easily manage limits,
                            freeze cards, and protect your physical card
                            details.
                        </p>
                    </div>
                    ...
                    <div className="bg-white/80 backdrop-blur-xl border border-white/50 p-8 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 group">
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            Rest easy knowing your funds are protected by
                            end-to-end encryption, multi-factor authentication,
                            and robust audit trails across all actions.
                        </p>
                    </div>
            ...
            <div className="relative bg-white mt-10 border-t border-gray-200">
                <div className="max-w-7xl mx-auto py-20 px-6 lg:px-8 text-center flex flex-col items-center">
                    ...
                    <Link href="/auth/signup">
                        <Button
                            size="lg"
                            className="bg-blue-600 hover:bg-blue-700 text-white shadow-xl px-8 py-6 rounded-full text-lg font-bold transition-all hover:scale-105 active:scale-95"
                        >
                            Open Free Account
                        </Button>
                    </Link>
