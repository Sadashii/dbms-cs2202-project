                                ...
                                <div className="space-y-4">
                                    {sessions.map((session: any) => {
                                        ...
                                        return (
                                            <div
                                                key={session._id}
                                                className={`flex justify-between items-center p-4 rounded-xl ${isOnline ? "border border-blue-100 dark:border-blue-900/30 bg-blue-50/50 dark:bg-blue-900/10" : "border border-gray-100 dark:border-slate-800"}`}
                                            >
                                                <div className="flex items-center gap-4">
                                                    <div
                                                        className={`w-10 h-10 ${isOnline ? "bg-white dark:bg-slate-800 shadow-sm" : "bg-gray-50 dark:bg-slate-800 shadow-sm"} rounded-full flex items-center justify-center`}
                                                    >
                                                        <svg
