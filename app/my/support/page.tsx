  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 animate-fade-in transition-colors">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white transition-colors">Support Center</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400 transition-colors">View your support tickets and contact customer care.</p>
        </div>
              ...
              {isLoading ? (
                <tr>
                  <td colSpan={5} className="px-6 py-10 text-center">
                    <div className="flex justify-center"><div className="animate-spin rounded-full h-6 w-6 border-b-2 border-blue-600 dark:border-blue-400"></div></div>
                  </td>
                </tr>
              ) : tickets.length === 0 ? (
                <tr>
                  <td colSpan={5} className="px-6 py-10 text-center text-gray-500 dark:text-gray-400 transition-colors">
                ...
                tickets.map((ticket) => (
                  ...
                  >
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-mono text-gray-500 dark:text-gray-400 transition-colors">{ticket.ticketId}</td>
                    <td className="px-6 py-4 text-sm font-medium text-gray-900 dark:text-gray-100 transition-colors">{ticket.subject}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400 transition-colors">{ticket.category}</td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full transition-colors ${getStatusBadgeColor(ticket.currentStatus)}`}>
