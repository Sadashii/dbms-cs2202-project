    ...
    return (
        <div className="max-w-7xl mx-auto space-y-6 animate-fade-in transition-colors">
            ...
            {accountRequests
                ...
                .map((accountRequest) => (
                    <div
                        key={accountRequest._id}
                        className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800/30 rounded-xl p-6 shadow-sm transition-colors"
                    >
                        <div className="flex items-center justify-between mb-4">
                            <div>
                                <h2 className="text-lg font-bold text-blue-900 dark:text-blue-400">
                                    Account Request Status:{" "}
                                    {accountRequest.currentStatus.replace(
                                        "_",
                                        " ",
                                    )}
                                </h2>
                            ...
                            <thead className="bg-gray-50 dark:bg-slate-800/50 border-b border-gray-100 dark:border-slate-800">
                                <tr>
                                    {[
                                        ...
                                        <th
                                            key={h}
                                            className={`p-4 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase ${h === "Actions" ? "text-right" : ""}`}
                                        >
                                            {h}
                                        </th>
                                    ))}
            ...
            <Modal
                ...
                description={
                    kycStatus === "pending"
                        ? ""
                        : "Please verify your identity to open this account."
                }
            >
                {kycStatus === "pending" ? (
                    <div className="py-8 text-center space-y-4 animate-fade-in">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 px-4">
                            ...
                            submitted. Our team will verify them shortly.
                        </p>
                        <div className="pt-6">
                            <Button
            ...
            <Modal
                ...
                description="Move money between your accounts or to a saved recipient."
            >
