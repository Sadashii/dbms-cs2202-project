                        ...
                        <div className="mx-auto max-w-2xl text-center animate-slide-in-from-bottom">
                            <div className="mb-8 flex justify-center">
                                <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 dark:text-gray-300 ring-1 ring-gray-900/10 dark:ring-white/10 hover:ring-gray-900/20 dark:hover:ring-white/20 transition-all">
                                    Announcing our new Corporate APIs.{" "}
                                    <Link
                                        href="/features"
                            ...
                            <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">
                                Secure, scalable, and API-first. VaultPay
                                provides the financial infrastructure you need
                                to manage corporate accounts, issue cards, and
                                automate ledger transfers in real-time.
                            </p>
            ...
            <div className="bg-slate-50 dark:bg-slate-900 py-24 sm:py-32 border-t border-gray-100 dark:border-slate-800 transition-colors">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl lg:text-center">
                        ...
                        <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">
                            Built on a double-entry ledger architecture with
                            ACID-compliant transactions, VaultPay guarantees
                            mathematical accuracy across all your operations.
                        </p>
                    </div>
                        ...
                        <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
                            ...
                            <div className="relative pl-16">
                                ...
                                <dd className="mt-2 text-base leading-7 text-gray-600 dark:text-gray-400">
                                    Instantly provision multi-currency accounts.
                                    Support for USD, EUR, and INR natively with
                            ...
                            <div className="relative pl-16">
                                ...
                                <dd className="mt-2 text-base leading-7 text-gray-600 dark:text-gray-400">
                                    Issue PCI-compliant Visa and MasterCard
                                    corporate cards to your team instantly.
                                    Manage limits down to the penny.
                                </dd>
                            </div>
                            ...
                            <div className="relative pl-16">
                                ...
                                <dd className="mt-2 text-base leading-7 text-gray-600 dark:text-gray-400">
                                    Military-grade encryption, time-based
                                    one-time passwords (TOTP), and complete
                            ...
                            <div className="relative pl-16">
                                ...
                                <dd className="mt-2 text-base leading-7 text-gray-600 dark:text-gray-400">
                                    Never lose a cent. Our API uses
                                    multi-document atomic locking to ensure
                                    transfers fully succeed or roll back
                                    cleanly.
                                </dd>
                            </div>
                        </dl>
