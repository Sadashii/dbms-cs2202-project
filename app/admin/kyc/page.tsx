...
export default function AdminKYCPage() {
    ...
    const filteredRecords = groupedRecords.filter((group) => {
        ...
        const matchesDocType =
            docTypeFilter === "All" ||
            group.documents.some((document) => document.type === docTypeFilter);
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 font-medium">
                            Registry of identity protocols awaiting manual
                            audit.
                        </p>
                    </div>
                ...
                <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-[2rem] shadow-2xl overflow-hidden transition-colors">
                    <div className="overflow-x-auto custom-scrollbar">
                        <table className="w-full text-left border-collapse min-w-[900px]">
                          ...
                          ${
                              group.highestPriorityStatus === "Verified"
                                  ...
                                  : group.highestPriorityStatus === "Rejected"
