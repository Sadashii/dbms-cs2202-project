                ...
                <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div className="grid gap-3 sm:grid-cols-3">
                        {[
                            ...
                            <div
                                key={s.label}
                                className="rounded-[1.75rem] border border-gray-100 bg-white px-6 py-5 shadow-sm dark:border-slate-800 dark:bg-slate-900 md:min-w-[8rem]"
                            >
                                <p className="text-[10px] font-black uppercase tracking-[0.24em] text-gray-400 dark:text-gray-500">
                                    {s.label}
                                </p>
                                <p
                                    className={`mt-3 text-4xl font-black leading-none ${s.color}`}
                                >
                                    {s.count}
                                </p>
                            </div>
