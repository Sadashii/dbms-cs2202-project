                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                    <div>
                        <h1 className="text-3xl font-black text-gray-900 dark:text-white tracking-tighter uppercase">
                            Protocol Entry Queue
                        </h1>
                        <p className="text-sm text-gray-400 dark:text-gray-500 font-bold tracking-widest uppercase mt-1">
                            Verification Stream
                        </p>
                    </div>
                        ...
                        <table className="w-full text-left min-w-[900px] border-collapse">
                            <thead className="bg-gray-50/50 dark:bg-slate-800/50 border-b border-gray-100 dark:border-slate-800">
                                <tr>
                                    ...
                                    <th className="p-6 text-right text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">
                                        Override
                                    </th>
                                </tr>
                            </thead>
                                ...
                                {paginatedRequests.length === 0 ? (
                                    ...
                                    paginatedRequests.map((req) => {
                                        ...
                                        const verifiedDocsCount = (
                                            ...
                                            (k) =>
                                                requiredDocs.includes(
                                                    k.documentType,
                                                ) &&
                                                k.currentStatus === "Verified",
                                        ).length;
                                        const totalRequired =
                                            requiredDocs.length;
                                        const progressPercent =
                                            ...
                                            100;
                                        const isReady =
                                            verifiedDocsCount === totalRequired;
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <td className="p-6">
                                                    <div className="text-xs font-black text-gray-700 dark:text-gray-300 uppercase tracking-wide">
                                                        {req.accountType}
                                                    </div>
                        ...
                        <div className="p-8 border-t border-gray-100 dark:border-slate-800 bg-gray-50/30 dark:bg-slate-800/20 flex items-center justify-between">
                            ...
                            <div className="flex gap-3">
                                <Button
                                    ...
                                    className="rounded-xl font-black text-[10px] uppercase h-10 px-6 dark:border-slate-800 dark:text-gray-400"
                                >
                                    Previous
                                </Button>
                                <Button
            ...
            >
                <form onSubmit={handleReject} className="space-y-6">
                    ...
                    <div className="bg-red-50 dark:bg-red-900/10 p-5 rounded-3xl border border-red-100 dark:border-red-900/20">
                        <p className="text-[10px] font-black text-red-700 dark:text-red-400 uppercase tracking-widest mb-1">
                            Critical Signal
                        </p>
                        <p className="text-xs text-red-600 dark:text-red-300 font-medium leading-relaxed">
                            Rejecting this protocol halts account creation. The
                            entry principal will need to re-submit records.
                        </p>
                    </div>
                    <div className="flex justify-end gap-3 pt-6 border-t dark:border-slate-800">
                        <Button
                            ...
                            className="rounded-xl font-black uppercase text-[10px] dark:text-gray-400"
                        >
                            Withdraw
                        </Button>
                        <Button
                            type="submit"
                            variant="primary"
                            className="bg-red-600 hover:bg-red-700 text-white rounded-xl font-black uppercase text-[10px] px-8"
                        >
                            Confirm Rejection
                        </Button>
                    </div>
