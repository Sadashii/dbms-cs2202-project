                        ...
                        >
                            ...
                            <div className="pt-6 border-t border-gray-100 dark:border-slate-800">
                                <button
                                    type="submit"
                                    disabled={isLoading}
                                    className={`px-10 py-4 rounded-2xl font-black uppercase text-xs tracking-widest text-white transition-all w-full md:w-auto shadow-lg shadow-amber-500/20 ${isLoading ? "bg-amber-400 cursor-not-allowed opacity-50" : "bg-amber-600 hover:bg-amber-700 active:scale-95"}`}
                                >
                                    {isLoading
                                        ? "Fetching..."
                                        : "Verify Registry"}
                        ...
                        >
                            ...
                            <div className="pt-8 border-t border-gray-100 dark:border-slate-800 flex justify-end">
                                <button
                                    ...
                                    className={`px-10 py-4 rounded-2xl font-black uppercase text-xs tracking-widest text-white transition-all shadow-xl flex items-center justify-center gap-3 ${isLoading || parseFloat(amount) > accountDetails.balance ? "bg-gray-300 dark:bg-slate-800 cursor-not-allowed grayscale" : "bg-amber-600 hover:bg-amber-700 shadow-amber-500/20 active:scale-95"}`}
                                >
                                    {isLoading
                                        ? "Executing..."
