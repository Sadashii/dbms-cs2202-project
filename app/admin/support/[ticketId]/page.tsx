...
export default function AdminTicketViewPage() {
    ...
    if (user?.role !== "Admin")
        return (
            <div className="p-8 text-center text-red-600 font-black uppercase">
                Unauthorized
            </div>
        );
                    ...
                    <div className="space-y-6 flex-1">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-1">
                                <p className="text-[9px] font-black text-gray-400 dark:text-gray-500 uppercase">
                                    Category
                                </p>
                            ...
                            <div className="space-y-1">
                                ...
                                <span className="px-2 py-0.5 text-[9px] font-black rounded bg-gray-200 dark:bg-slate-800 text-gray-700 dark:text-gray-300 uppercase">
                                    {ticket.priority}
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="pt-6 border-t border-gray-100 dark:border-slate-800">
                            <p className="text-[9px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-4">
                                Command Override
                            </p>
                ...
                <div className="flex-1 flex flex-col bg-white dark:bg-slate-950">
                    ...
                    <div className="px-8 py-5 border-b border-gray-100 dark:border-slate-800 bg-white/80 dark:bg-slate-950/80 backdrop-blur flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[10px] font-black text-emerald-600 dark:text-emerald-500 uppercase">
                                Secure Link
                            </span>
                        </div>
                    </div>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <p
                                            className={`text-[9px] font-mono mt-3 text-right uppercase tracking-tighter ${isSupport ? "text-blue-200" : "text-gray-400 dark:text-gray-500"}`}
                                        >
                                            {new Date(
                                                msg.createdAt,
                                            ).toLocaleTimeString([], {
                    ...
                    <div className="p-6 bg-gray-50/50 dark:bg-slate-900/50 border-t border-gray-100 dark:border-slate-800 transition-colors">
                        ...
                        <div className="mt-3 flex items-center gap-2">
                            <kbd className="hidden sm:inline-block px-1.5 py-0.5 text-[9px] font-mono text-gray-400 border rounded">
                                Enter
                            </kbd>
                            <span className="text-[9px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">
                                to dispatch message packet
                            </span>
                        </div>
                    </div>
                </div>
